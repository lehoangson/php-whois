...
/**
 *
 * Functions from WHMCS 5.2.15
 * Recompiled by: Peter Le [04/23/2019]
 *
 **/

function lookupDomain($sld, $ext, $whois_server, $whois_line) {
	 ...
	 $whoisservers = file_get_contents(dirname(__FILE__) . "/servers.txt");
